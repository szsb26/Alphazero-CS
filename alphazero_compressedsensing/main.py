...
args = {
    ...
    'alpha':1e-03,  #note that reward for a terminal state is -alpha||x||_0 - gamma*||A_S*x-y||_2^2. The smaller alpha is, the less weight the algorithm gives in selecting a sparse solution.
